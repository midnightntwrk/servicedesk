...
We welcome your contributions to the Midnight Foundation! By contributing, you'll play a vital role in shaping the future of a blockchain focused on data privacy.
...
Use one of the [templates] to submit an issue to the Project Board. The Foundation team will address it if it's relevant.
...
* **Feature Request:** These should be reported via the product process, not the support proces. 
* **Enhancement:** (WIP)

## Code Contribution Process

* **Pull Requests:** Code contributions are submitted via Pull Requests.
* **Fork the Repository:** Create your own fork of the Foundation repository.
